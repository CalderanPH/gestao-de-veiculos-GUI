    ...
    public static ImprimirExcluirCarga getImprimirExcluirCarga() {
     ...
     public void imprimir() {
        ...
        for (Carga carga : bdVeiculos.getListaCarga()) {
            modelo.insertRow(poslin, new Object[]{carga.getPlaca(), carga.getMarca(), carga.getModelo(), carga.getCor(), carga.getQtdRodas(), carga.getVelocMax(), carga.getMotor().getQtdPist(), carga.getMotor().getPontencia(), carga.getTara(),carga.getCargaMax()});
            poslin++;
        }
    }
     
     public void excluirCargaAll(){
            bdVeiculos.removeCargaAll(carga);   
            if(carga != null){                
                JOptionPane.showMessageDialog(null, "Veiculos de Carga removidos com sucesso! ", "ERRO de Consulta",1);                 
            }
...
//    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Placa", "Marca", "Modelo", "Cor", "Qtd. Rodas", "Veloc. Máx", "Qtd. Pistões", "Potência", "Tara", "Carga Máx"
            }
        ) {
