...
public class ConsultarDeleteCarga extends javax.swing.JFrame {
    ...
    public void consultarPlaca() {
        ...
        try {
            ...
            if (carga != null) {
                ...
                ctRodas.setText(String.valueOf(carga.getQtdRodas()));
                ctVelocMax.setText(String.valueOf(carga.getVelocMax()));
                ctPistoes.setText(String.valueOf(carga.getMotor().getQtdPist()));
    ...
    private void initComponents() {
        ...
        setTitle("Consultar / Deletar Carga");

        jLabel1.setText("Informe a Placa");

        jLabel2.setText("Tara");

        jLabel3.setText("Carga Máxima");
        ...
        jLabel8.setText("Velocidade Máxima");

        jLabel9.setText("Qtd. Pistões");

        jLabel10.setText("Potência");
