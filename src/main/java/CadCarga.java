...
public class CadCarga extends javax.swing.JFrame {
    ...
    private static CadCarga cadCargaUnico;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Velocidade Máxima");
    ...
    public static CadCarga getCadCarga() {
        if (cadCargaUnico == null) {
            cadCargaUnico = new CadCarga();
        }
        return cadCargaUnico;
    }
    ...
    public void cadastrar() {
        ...
        try {
            ...
            carga.setQtdRodas(Integer.parseInt(ctRodas.getText()));
            carga.setPlaca(Integer.parseInt(ctPlaca.getText()));
            carga.getMotor().setQtdPist(Integer.parseInt(ctPistoes.getText()));
            carga.getMotor().setPontencia(Integer.parseInt(ctPotencia.getText()));
            carga.setVelocMax(Integer.parseInt(ctVelocMax.getText()));
