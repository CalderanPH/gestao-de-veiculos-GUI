...
public class GestMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblGestao.setText("Escolha qual tipo de Veículo deseja cadastrar!");
    ...
    public static void main(String[] args) {
        JFrame jan1 = new GestMain();
        jan1.setSize(650, 550);
