...
public class ConsultarDeletePasseio extends javax.swing.JFrame {

    private Passeio passeio = new Passeio();
    private final BDVeiculos bdVeiculos = new BDVeiculos();

    private static ConsultarDeletePasseio consultarDeletePasseio;

    public ConsultarDeletePasseio() {
        initComponents();
    }

    public static ConsultarDeletePasseio getConsultarDelete() {
        if (consultarDeletePasseio == null) {
            consultarDeletePasseio = new ConsultarDeletePasseio();
        }
        return consultarDeletePasseio;
    }
    ...
    public void consultarPlaca() {
        ...
        try {
            ...
            if (passeio != null) {
                ctPassageiros.setText(String.valueOf(passeio.getQuantidadePassageiros()));
                ctMarca.setText(passeio.getMarca());
                ctModelo.setText(passeio.getModelo());
                ctCor.setText(passeio.getCor());
                ctRodas.setText(String.valueOf(passeio.getQuantidadeRodas()));
                ctVelocMax.setText(String.valueOf(passeio.getVelocidadeMax()));
                ctPistoes.setText(String.valueOf(passeio.getMotor().getQuantidadePistao()));
    ...
    private void initComponents() {
        ...
        lblVelocMax.setText("Velocidade M�xima");
