...
public class VeiculosPasseio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Ve�culos de Veiculo.Passeio");

        lblTitle.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lblTitle.setText("Escolha uma op��o a baixo.");
    ...
    public void cadastrar() {
        CadastroPasseio.getCadPasseio().setVisible(true);
    }

    public void consultar() {
        ConsultarDeletePasseio.getConsultarDelete().setVisible(true);
    }

    public void imprimirExluir() {
        ImprimirExcluirPasseio.getImprimirExcluir().setVisible(true);
    }
